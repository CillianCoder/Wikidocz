<?php
/**
 * Shortcodes: hero_content, hero_image, featured_categories.
 */
add_shortcode( 'hero_content', 'wikidocz_hero_content_shortcode' );
function wikidocz_hero_content_shortcode( $atts ) {
    ...
    $output = sprintf(
        '<div class="hero-cat">%s</div>
         ...
         <p class="meta">By %s &middot; %s &middot; %s min read</p>
         <div class="hero-actions">
           <a class="hero-btn" href="%s">Start reading</a>
           <a class="hero-btn hero-btn-secondary" href="https://wikidocz.com/article">Explore topics</a>
         </div>',
        $cat_tag,
...
add_shortcode( 'hero_image', 'wikidocz_hero_image_shortcode' );
function wikidocz_hero_image_shortcode( $atts ) {
    $a = shortcode_atts( [ 'post_id' => 0 ], $atts );
    $args = $a['post_id']
        ? [ 'p' => $a['post_id'], 'posts_per_page' => 1, 'post_type' => 'post' ]
        : [ 'posts_per_page' => 1, 'orderby' => 'date', 'order' => 'DESC' ];
...
function wikidocz_featured_categories_shortcode( $atts ) {
    ...
    <div class="fc-wrapper">
        ...
        <div class="fc-grid">
            ...
            <a class="fc-card" href="/category/health&wellness/" style="--fc-bg:#F0FDF4;--fc-accent:#16A34A;--fc-glow:rgba(22,163,74,.12)">
                <div class="fc-icon-wrap">
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/><path d="M3.5 12h3l2 -3 3 6 2 -3h3.5"/></svg>
                </div>
                <h3 class="fc-name">Health & Wellness</h3>
            </a>
